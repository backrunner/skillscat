        ...
        {#if open}
          <div {...props} class="dialog" transition:fly={{ y: 10, duration: 200 }}>
            <div class="dialog-header">
              <Dialog.Title class="login-dialog-title">{messages.auth.signInTitle}</Dialog.Title>
              <Dialog.Close class="login-dialog-close" aria-label={messages.common.close}>
            ...
            <div class="dialog-content">
              ...
              <div class="login-buttons">
                ...
                >
                  ...
                  <span>{messages.auth.continueWithGithub}</span>
                </button>
              </div>

              <p class="dialog-footer-text">
                {messages.auth.agreementText}
              </p>
            </div>
          </div>
        {/if}
