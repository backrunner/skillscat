...
const categoryLocaleCopy: Record<SupportedLocale, CategoryLocaleCopy> = {
  ...
  'zh-CN': {
    ...
    categories: {
      ...
      design: { name: '设计', description: 'UI/UX 方向、视觉设计与设计系统' },
      'ui-components': { name: 'UI 组件', description: '基于代码的 UI 组件生成与样式实现' },
      ...
      research: { name: '资讯收集', description: '跨来源检索、整理与摘要' },
  ...
  ja: {
    ...
    categories: {
      ...
      design: { name: 'デザイン', description: 'UI/UX の方向性、ビジュアルデザイン、デザインシステム' },
      'ui-components': { name: 'UI コンポーネント', description: 'コードベースの UI コンポーネント生成とスタイリング' },
      ...
      research: { name: '情報収集', description: '複数ソースの調査、収集、要約' },
  ...
  ko: {
    ...
    categories: {
      ...
      design: { name: '디자인', description: 'UI/UX 방향성, 비주얼 디자인, 디자인 시스템' },
      'ui-components': { name: 'UI 컴포넌트', description: '코드 기반 UI 컴포넌트 생성과 스타일링' },
      ...
      research: { name: '정보 수집', description: '여러 출처의 조사, 수집, 요약' },
